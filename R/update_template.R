...
#' }
#'
#' @seealso \code{\link{update_template_interactive}} for guided interactive mode
#'
#' @export
update_template <- function(package = get_package_name(verbose = FALSE),
                           action = NULL,
                           var_name = NULL,
                           default_value = NULL,
                           description = NULL,
  ...
  if (is.null(action)) {
    .icy_stop("action is required. Use update_template_interactive() for guided mode.")
  }
